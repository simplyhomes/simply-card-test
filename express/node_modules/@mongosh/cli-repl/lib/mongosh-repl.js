...
class MongoshNodeRepl {
    ...
    async initialize(serviceProvider, moreRecentMongoshVersion) {
        ...
        this.inspectCompact =
            (_d = (await this.getConfig('inspectCompact'))) !== null && _d !== void 0 ? _d : this.inspectCompact;
        this.inspectDepth =
            (_e = (await this.getConfig('inspectDepth'))) !== null && _e !== void 0 ? _e : this.inspectDepth;
        this.showStackTraces =
            (_f = (await this.getConfig('showStackTraces'))) !== null && _f !== void 0 ? _f : this.showStackTraces;
        this.redactHistory =
            (_g = (await this.getConfig('redactHistory'))) !== null && _g !== void 0 ? _g : this.redactHistory;
        ...
        {
            const globalCryptoDescriptor = (_h = Object.getOwnPropertyDescriptor(repl.context, 'crypto')) !== null && _h !== void 0 ? _h : {};
            if (((_j = globalCryptoDescriptor.value) === null || _j === void 0 ? void 0 : _j.subtle) ||
                ((_l = (_k = globalCryptoDescriptor.get) === null || _k === void 0 ? void 0 : _k.call(null)) === null || _l === void 0 ? void 0 : _l.subtle)) {
